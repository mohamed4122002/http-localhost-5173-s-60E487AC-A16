    ...
    <div className="relative min-h-screen bg-brand-dark flex items-center justify-center p-6 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <motion.div
          ...
          className="absolute top-[10%] right-[15%] w-[30rem] h-[30rem] bg-brand-glow/20 rounded-full blur-[100px]"
        />
        <motion.div
          animate={{ x: [0, 40, 0], y: [0, -50, 0] }}
          transition={{ duration: 12, repeat: Infinity, ease: "easeInOut" }}
          className="absolute bottom-[10%] left-[15%] w-96 h-96 bg-brand-accent/20 rounded-full blur-[120px]"
        />
      </div>
      ...
      >
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-4xl font-display font-black text-white text-center">
            Create <span className="text-brand-glow">Account</span>
          </h1>
        ...
        <form onSubmit={handleSignUp} className="space-y-6">
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-bold uppercase tracking-widest text-slate-500 ml-1">Email <span className="text-slate-600">(Optional)</span></label>
            <div className="relative group">
              ...
              <input
                type="email"
                className="w-full bg-slate-950/50 border border-white/5 rounded-2xl pl-12 pr-4 py-4 text-white focus:outline-none focus:border-cyan-400/50 focus:ring-4 focus:ring-cyan-400/10 transition-all placeholder:text-slate-600"
